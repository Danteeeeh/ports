...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Sanitize inputs
    $username = filter_input(INPUT_POST, 'student_username', FILTER_SANITIZE_STRING);
    $password = isset($_POST['student_password']) ? trim($_POST['student_password']) : '';
    $fullname = filter_input(INPUT_POST, 'student_fullname', FILTER_SANITIZE_STRING);
    $email = filter_input(INPUT_POST, 'student_email', FILTER_SANITIZE_EMAIL);
    $class = filter_input(INPUT_POST, 'student_class', FILTER_SANITIZE_STRING);
            ...
            if ($checkUser && $checkUser->num_rows > 0) {
                ...
                try {
                    ...
                    if ($insertUser) {
                        ...
                        $insertStudent = $db->insert('students', $studentData);
                        ...
                        if ($insertStudent) {
                            ...
                            $logData = [
                                ...
                                'description' => 'Student account created by admin: ' . $admin
                            ];
                            ...
                            throw new Exception('Failed to create student profile: ' . $db->getLastError());
                        }
                    } else {
...
<head>
    ...
    <title>Create Student Account - Admin Dashboard</title>
        ...
        <div class="form-container">
            ...
            <form method="POST" action="createstudent.php">
                <div class="form-group">
                    <label for="student_username" class="form-label required">Username</label>
                ...
                <div class="form-group">
                    <label for="student_password" class="form-label required">Password</label>
                ...
                <div class="form-group">
                    <label for="student_fullname" class="form-label required">Full Name</label>
                ...
                <div class="form-group">
                    <label for="student_class" class="form-label">Class/Section</label>
